...
INSERT INTO LOCATION_ENTITY(ID, ID_LOCATION, LATITUDE, LONGITUDE, MAP_ID) VALUES (1, 1, -500.0, 500.0, 1);

INSERT INTO LOCATION_ENTITY(ID, ID_LOCATION, LATITUDE, LONGITUDE, MAP_ID) VALUES (2, 2, -550.0, 520.0, 1);

INSERT INTO COMPLEMENTARY_INFORMATION_ENTITY(ID,DESCRIPTION,RECOMENDATION) VALUES (1,'Venezuela','Llevar comida');
