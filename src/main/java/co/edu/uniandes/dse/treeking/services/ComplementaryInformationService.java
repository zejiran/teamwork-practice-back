...
public class ComplementaryInformationService {
	...
	@Transactional
	public ComplementaryInformationEntity createComplementaryInformation(ComplementaryInformationEntity complementaryInformation) throws IllegalOperationException {
		return complementaryinformationRepository.save(complementaryInformation);
	}
}
